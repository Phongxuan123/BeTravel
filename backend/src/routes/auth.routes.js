 ...
 */
router.post("/google/link", authenticateToken, linkGoogle);
...
router.post("/verify-reset-otp", resetRateLimit, verifyResetOtp);

router.post("/resend-reset-otp", resetRateLimit, resendResetOtp);
